...
const manager_route = {
    ...
    routes: [
        ...
        },
        {
            hideInMenu: true,   // 隐藏不显示
            name: 'charge_template_info', icon: 'icon-charge-manage',
            path: '/manager/charge-template/copy/:id', component: './sys-manager/charge-template/form',
        },
        // TODO: 报价数据
        {
            hideInMenu: true,   // 隐藏不显示
            name: 'charge_quotation_list', icon: 'icon-charge-quotation',
            path: '/manager/charge-quotation/list', component: './sys-manager/charge-quotation/list',
        },
        {
            hideInMenu: true,   // 隐藏不显示
            name: 'charge_quotation_info', icon: 'icon-charge-quotation',
            path: '/manager/charge-quotation/form/:id', component: './sys-manager/charge-quotation/form',
        },
        // TODO: 部门
        {
            name: 'department_list', icon: 'icon-department-manager',
            path: '/manager/department', component: './sys-manager/department',
        },
        {
            hideInMenu: true,   // 隐藏不显示
            name: 'department_form', icon: 'icon-department-manager',
            path: '/manager/department/form/:id', component: './sys-manager/department/form',
        },
        // TODO: 项目
        {name: 'project_list', icon: 'icon-project', path: '/manager/project', component: './sys-manager/project',},
        {
            hideInMenu: true,   // 隐藏不显示
            name: 'project_info', icon: 'icon-project',
            path: '/manager/project/form/:id', component: './sys-manager/project/form',
        },
        // TODO: 用户
        {name: 'user', icon: 'icon-user-manager', path: '/manager/user', component: './sys-manager/user/user-list',},
        // TODO: edi
        {name: 'edi', icon: 'icon-EDI', path: '/manager/edi/list', component: './sys-manager/edi',},
        {
            hideInMenu: true,   // 隐藏不显示
            name: 'edi_info', icon: 'icon-EDI', path: '/manager/edi/form/:id', component: './sys-manager/edi/form',
        },
        // TODO: 用户权限
        {
        ...
        {name: 'bpmn', icon: 'icon-user-manager', path: '/manager/bpmn', component: './sys-manager/bpmn',},
    ],
};
