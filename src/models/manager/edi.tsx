...
import {addEDIAPI, deleteEDIAPI, editEDIAPI, operateEDIAPI, queryEDIAPI, queryEDIInfoAPI} from '@/services/smart/manager/edi'
...
export default () => {
    ...
    //region TODO: 接口
    // TODO: 获取部门列表<详细数据>请求
    const queryEDI = useCallback(async (params: APIManager.SearchEDIParams) => {
        // TODO: 请求后台 API
