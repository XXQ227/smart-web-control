...
import {
    ...
    queryInvoiceTypeAPI
} from "@/services/smart/manager/invoiceType";

type APIInvoiceType = APIManager.InvoiceType;
...
export default () => {
    ...
    //region TODO: 接口
    // TODO: 获取 发票类型 列表
    const queryInvoiceType = useCallback(async (params: APIManager.SearchPortParams) => {
