...
} from '@/services/smart/system/credit'

type APICredit = APISystem.Credit;

export default () => {

    //region TODO: 接口
    // TODO: 获取 未做信控客户 列表
    const queryUnCreditControl = useCallback(async (params: APISystem.SearchCreditParams) => {
    ...
    // TODO: 获取 信控 列表
    const queryCreditControl = useCallback(async (params: APISystem.SearchCreditParams) => {
