...
} from '@/services/smart/system/port';
...
export default () => {
    ...
    const querySea = useCallback(async (params: APISystem.SearchPortParams) => {
        // TODO: 请求后台 API
    ...
    //region TODO: 获取水运港口列表
    const queryAir = useCallback(async (params: APISystem.SearchPortParams) => {
        // TODO: 请求后台 API
    ...
    const queryLand = useCallback(async (params: APISystem.SearchPortParams) => {
        // TODO: 请求后台 API
    ...
    const queryTradePlace = useCallback(async (params: APISystem.SearchPortParams) => {
        // TODO: 请求后台 API
