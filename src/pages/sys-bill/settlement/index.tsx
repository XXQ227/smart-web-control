...
const Settlement: React.FC<RouteChildrenProps> = () => {
     ...
     * @returns
     */
    function handleModalOP(state: boolean, isCreateSuccess?: boolean) {
        if (state) {
    ...
    function handleTableRowChange(selectedRowKeys: React.Key[], selectedRows: any[]) {
        ...
        setSettleInfo({
            ...
            // TODO: 选中行的客户、账单币种
            businessName: selectRow.businessName, billCurrencyName: selectRow.billCurrencyNameState
        });
    }
    /**
    ...
    const columns: ProColumns[] = [
        ...
        {title: 'B-Line', dataIndex: 'businessLine', width: 60, valueEnum: BUSINESS_LINE_ENUM},
        {title: 'Invoice No.', dataIndex: 'num', width: 120},
        {title: 'Job No.', dataIndex: 'jobCodes', key: 'jobCode', width: 150},
                        ...
                        return (
                            <FooterToolbar extra={<Button onClick={() => history.goBack()}>Back</Button>}>
                                <Button
                                    ...
                                    disabled={selectedKeys?.length === 0 || settleInfo.businessLineState || settleInfo.billCurrencyNameState}
                                >Settle</Button>
                            </FooterToolbar>
                        );
                    },
