...
const ModalLevel2Auth: React.FC<Props> = (props) => {
    ...
    const [AuthResourceListVO, setAuthResourceListVO] = useState<any[]>([]);
    const [AuthParentVO, setAuthParentVO] = useState<any>({});
...
export default ModalLevel2Auth;