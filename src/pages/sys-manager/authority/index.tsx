...
const AuthResourceIndex: React.FC<RouteChildrenProps> = () => {
    ...
    useEffect(() => {
        console.log(AuthResourceListVO);
    }, [AuthResourceListVO]);
    ...
    const handleDetail = (record: any) => {
        ...
        history.push({pathname: `/manager/auth/form/${btoa(record.id)}`});
    }

    const columns: ProColumns<APIAuthResource>[] = [
    // const columns: ColumnsType<APIAuthResource> = [
        {
            title: 'Name',
            dataIndex: 'name',
            align: 'left',
    ...
    return (
        ...
        >
                ...
                title={
                    <Search
                        ...
                        onSearch={async (val: any) => {
                            ...
                            await handleGetAuthResourceList(searchParams);
                        }}
                    />
                }
            ...
            >
                <ProForm
                    form={form}
                    request={async () => handleGetAuthResourceList(searchParams)}
                >
                    <Table
                        rowKey={'id'}
                        bordered={true}
                        ...
                        rowClassName={(record: APIAuthResource) => record.enableFlag ? 'ant-table-row-disabled' : ''}
