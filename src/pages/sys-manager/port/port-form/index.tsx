...
const PortForm: React.FC<RouteChildrenProps> = (props) => {
     ...
     * @returns
     */
    const handlePortChange = (filedName: string, val: any, option: any) => {
                        ...
                        <Col span={6}>
                            <Form.Item label={'Country'} name={'CountryID'}>
                                <SearchInput
                                    ...
                                    handleChangeData={(val: any, option: any) => handlePortChange('CountryID', val, option)}
                                />
                            </Form.Item>
                        </Col>
                        <Col span={6}>
                            <Form.Item label={'City'} name={'CityID'}>
                                <SearchInput
                                    ...
                                    handleChangeData={(val: any, option: any) => handlePortChange('CityID', val, option)}
                                />
                            </Form.Item>
                        </Col>
                        <Col span={6}>
