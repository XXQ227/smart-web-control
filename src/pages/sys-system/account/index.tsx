...
import AddAccountModal from "@/pages/sys-system/account/AddAccountModal";
import {BRANCH_ID} from "@/utils/auths";

const { Search } = Input;

type APIAccountPeriod = APISystem.AccountPeriod;
type APISearchAccountParams = APISystem.SearchAccountParams;
...
const AccountListIndex: React.FC<RouteChildrenProps> = () => {
    ...
    } = useModel('system.account', (res: any) => ({
