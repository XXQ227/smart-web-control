...
import AddCustomerModal from "@/pages/sys-system/business-unit/payer/AddCustomerModal";

export type LocationState = Record<string, unknown>;
type APIPayer = APISystem.BUP;
...
const PayerListIndex: React.FC<RouteChildrenProps> = (props) => {
    ...
    useEffect(() => {
        const handleBeforeUnload = () => {
            if (state) {
                history.push({pathname: '/system/business-unit/payer'});
            }
        };
