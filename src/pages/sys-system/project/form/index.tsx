...
type APIProject = APISystem.Project;
...
const ProjectForm: React.FC<RouteChildrenProps> = (props) => {
    ...
    } = useModel('system.project', (res: any) => ({
    ...
    return (
        ...
        >
            ...
            >
                ...
                <FooterToolbar
                    extra={<Button onClick={() => history.push({pathname: '/system/project/list'})} icon={<LeftOutlined/>}>Back</Button>}>
                    <Space>
